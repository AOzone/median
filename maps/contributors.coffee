module.exports = [
  ...
  ,
  {
    ...
    location: 'New York City - New Haven'
    links: ['[kellereasterling.com](http://kellereasterling.com/)', '[extrastatecraft.net](http://extrastatecraft.net/Projects)']
    bio: 'Keller Easterling is an architect, writer and professor at Yale University. Easterling’s research and writing was included in the 2014 Venice Biennale, and she has been exhibited at Storefront for Art and Architecture in New York, the Rotterdam Biennale, and the Architectural League in New York. Easterling has lectured and published widely in the United States and abroad.'
    azone_username: ''
    azone_reviews: []
    azone_funds: []
  }
  ...
  ,
  {
    ...
    bio: 'Vinay Gupta works at both the theoretical level, building models and mapping tools like Simple Critical Infrastructure Maps and at the completely practical level, where he is best known as the designer of the hexayurt, an award-winning replacement for the disaster relief tent. Gupta helped start the US National Defense University STAR-TIDES program on humanitarian assistance, consulted on urban resilience for Arup, and am an associate fellow of the UCL Institute.'
    azone_username: ''
    azone_reviews: []
    azone_funds: []
  }
